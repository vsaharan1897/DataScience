...
#This code plays a traditional game of hangman, but allows the user to cheat to win.
 
#The catch is that each guess produces possible words and stores in a key-value pair
#The set with the largest amounts of elements is chosen and given as a hint
#If there's a tie, the set with the fewest hints revealed is selected
#If another tie, the set is randomly chosen

#The details are provided in cheat mode, allowing the user to see what possible words
#remain and which letters could lead to a correct guess

#You are given 5 turns in Normal Mode, 5+ in cheating mode. You will most likely 
# not guesss the correct answer, even when cheating 
